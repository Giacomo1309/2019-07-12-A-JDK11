...
import it.polito.tdp.food.model.Supporto;
...
public class FoodController {
	...
	void doCreaGrafo(ActionEvent event) {
		...
		try {
			id = Integer.parseInt(txtPorzioni.getText());
		} catch (NumberFormatException e) {
			txtResult.appendText("INSERIRE UN ID NEL FORMATO CORRETTO\n");
			return;
		}
		this.model.creaGrafo(id);
	...
	void doCalorie(ActionEvent event) {
		...
		List<Supporto> lista = new ArrayList(this.model.calorieCongiunte(f));
